...
{
    public partial class BucurestiRestaurants : UserControl
    {
        public BucurestiRestaurants()
        {
            InitializeComponent();
            LoadRestaurantData();
        }
        private void LoadRestaurantData()
        {
            ...
            string selectCommand = "SELECT * FROM Restaurant WHERE Oras = 'Bucuresti'";
            ...
            while (dr.Read())
            {
                ...
                panelOffset += 220; // Adjust this as needed
            }
        ...
        private void BucurestiRestaurants_Load(object sender, EventArgs e)
        {
